    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-slate-800 mb-6">Worldwide facilities insights</h2>
            <p className="text-lg text-slate-600 mb-8">
              Placeholder for Global FM Intelligence dashboard. This page will display worldwide facilities insights.
            </p>
